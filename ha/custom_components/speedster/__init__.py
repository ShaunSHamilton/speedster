...
async def async_setup(hass: HomeAssistant, config: ConfigType) -> bool:
    ...
    def _coordinator() -> SpeedsterCoordinator:
        ...
        if not entries:
            raise HomeAssistantError("Speedster is not set up")
    ...
    async def _build_report(call: ServiceCall) -> ServiceResponse:
...
async def _async_options_updated(hass: HomeAssistant, entry: SpeedsterConfigEntry) -> None:
